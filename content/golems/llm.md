...
>
> Sections were captured on different dates. Where this page disagrees with an individual docs page, the docs page is current.
...
Golems is a **Bun monorepo with 13 workspace packages** — six golem packages (ClaudeGolem as the Telegram router plus Recruiter, Teller, Jobs, Coach, and Content) plus shared infrastructure and tooling. Work splits between your local Mac (cognitive tasks), Railway cloud (data collection), and Vercel (web dashboard).
...
Yes. The 88 skills in `skills/golem-powers/` work as standalone Claude Code plugins. Install them individually:
