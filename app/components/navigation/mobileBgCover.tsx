...
const BottomMobileBgCover = () => {
  ...
  return (
    ...
    >
      {/* Bottom Right SVG */}
      <div
        className="absolute right-0 bottom-0 h-fit"
        style={{ bottom: `${bottomRightPosition}px` }}
      >
        <span
          className="absolute -right-3 size-36 bg-blue-500 opacity-60 blur-[45px]"
          style={{ bottom: `${bottomRightPosition}px` }}
        ></span>
        <BottomRightSvg />
      </div>
      ...
      <div
        ...
        style={{ bottom: `${bottomLeftPosition}px` }}
      >
        <span
          className="absolute -left-3 size-36 bg-blue-200 opacity-60 blur-[45px]"
          style={{ bottom: `${bottomLeftPosition - 150}px` }}
        ></span>
        <BottomLeftSvg />
      </div>
    </div>
...
const TopMobileBgCover = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-[54px] right-0 h-fit">
        <span className="absolute -right-3 -bottom-5 size-36 bg-blue-200 opacity-60 blur-[45px]"></span>
        <TopRightSvg />
      </div>

      {/* Top Left SVG - position changes based on page type */}
      <div
        className={`relative left-0 h-fit ${isHomeOrNotFoundPage ? "top-[175px]" : "top-[325px]"}`}
      >
        <span className="absolute -left-3 size-36 bg-blue-500 opacity-60 blur-[45px]"></span>
        <TopLeftSvg />
      </div>
    </div>
  );
