...
export const projects: Project[] = [
  {
    ...
    description:
      "A photography portfolio website built for showcasing professional photography work with image galleries and categories",
    ...
    productJourney: [
      {
        ...
        description:
          "A modern, responsive photography portfolio website with image galleries organized by categories",
  ...
  },
  {
    name: "Ofektive",
    description:
      "A fitness trainer portfolio website showcasing client transformations and training services",
    ...
    productJourney: [
      {
        ...
        description:
          "A responsive website for a fitness trainer showcasing client transformations and training services",
  ...
  },
  {
    name: "Sharon Fitness",
    description:
      "Personal trainer website designed to showcase fitness services, training programs, and client testimonials",
    ...
    productJourney: [
      {
        ...
        description:
          "A modern, responsive website for a personal trainer featuring fitness services and training programs",
  ...
  },
  {
    name: "Mayart Candles",
    description:
      "An e-commerce website for handcrafted candles with product catalog, shopping cart, and secure checkout",
    ...
    productJourney: [
      {
        ...
        description:
          "A full-stack e-commerce platform for handcrafted candles with product catalog, shopping cart, and secure checkout",
  ...
  },
  {
    ...
    description:
      "A multilingual website for Casona Diez Diez, a charming hostel located in San Telmo, Argentina, featuring room booking, contact forms, and interactive maps",
    ...
    productJourney: [
      {
        ...
        description:
          "A multilingual website for a hostel in Argentina with room booking functionality, contact forms, and interactive location maps",
